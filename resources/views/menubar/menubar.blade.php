		...
		<nav class="bg-white shadow-md">
			...
			<div class="hidden mobile-menu">
				<ul class="">
					...
					<li class=""><a href="/contact" class="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300">Contact Us</a></li>
					<li>
                        <div class="flex justify-center py-4">
                            <a href="" class="mx-2 py-2 px-2 font-medium text-gray-500 bg-gray-100 rounded hover:bg-green-500 hover:text-white transition duration-300">Log In</a>
                            <a href="" class="mx-2 py-2 px-2 font-medium text-white bg-green-500 rounded hover:bg-green-400 transition duration-300">Sign Up</a>
					</div></li>
				</ul>
			</div>
